...
//    $('#process-data-sku').click(uploadSkuFile);
    $('#process-data-store').click(uploadStoreFile($('#style-file')));
//    $('#process-data-sales').click(uploadSalesFile);
